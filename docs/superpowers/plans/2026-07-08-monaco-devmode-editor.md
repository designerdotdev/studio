...
- This package has no test suite (per CLAUDE.md). Test cycles are build commands with expected output plus verification against the host app at `/Users/tonylea/Sites/designer` (`php artisan serve`, then `/studio`).
