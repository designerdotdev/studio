...
- **Backend gate must not regress:** `cd /Users/tonylea/Sites/designer && php artisan studio:inline:verify` exits 0 with `Coverage: 365/369 fields mapped across 62 sections` and `Inertness: 57 identical, 0 diverged, 5 unrenderable, 577 sentinels`.
