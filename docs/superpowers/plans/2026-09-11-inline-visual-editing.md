...
- **No test runner exists in this package.** The TDD cycle in this plan runs against `php artisan studio:inline:verify`, built in Task 1. Run it from the host app root: `/Users/tonylea/Sites/designer`.
...
```bash
cd /Users/tonylea/Sites/designer && php artisan studio:inline:verify
```
...
```bash
cd /Users/tonylea/Sites/designer && php artisan serve &
sleep 3
...
```bash
cd /Users/tonylea/Sites/designer/packages/designer/studio && npm run build
```
