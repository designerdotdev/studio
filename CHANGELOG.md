...
- Flat, Linear-style chrome in both themes: hairlines between the bar, the sidebar, the site and the Assistant column; light appearance is all white; controls one size smaller (28px buttons and inputs, 24px segmented controls with the active segment lifted white, 28px rows, 6px radius).
