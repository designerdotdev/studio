{{-- The top bar: the editor's one piece of chrome above the site. Left,
     the sidebar toggle, the brand mark (the menu) and the page switcher;
     centre, the mode; right, the canvas widths, the Assistant (developer
     mode) and Publish. The `menu` and `actions` slots come from
     home.blade.php. --}}
